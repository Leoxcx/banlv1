...
@WebServlet("/userArrivesearchservlet")
public class UserArriveSearchServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        PageBean<UserArrive> allByPage = userArriveService.searchAllByPage(currentPage,rows,userArrivefromWeb);
