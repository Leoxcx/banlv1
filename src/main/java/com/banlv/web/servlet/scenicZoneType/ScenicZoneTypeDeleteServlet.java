...
@WebServlet("/scenicZoneTypedeleteservlet")
public class ScenicZoneTypeDeleteServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        int i = scenicZoneTypeService.deleteByScenicZoneTypeId(id);
