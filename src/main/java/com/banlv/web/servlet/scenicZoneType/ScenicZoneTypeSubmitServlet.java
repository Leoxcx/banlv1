...
@WebServlet("/scenicZoneTypesubmitservlet")
public class ScenicZoneTypeSubmitServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        int i = scenicZoneTypeService.addScenicZoneType(scenicZoneTypefromWeb);
