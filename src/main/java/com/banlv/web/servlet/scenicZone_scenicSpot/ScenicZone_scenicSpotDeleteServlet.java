...
@WebServlet("/scenicZone_scenicSpotdeleteservlet")
public class ScenicZone_scenicSpotDeleteServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        int i = scenicZone_scenicSpotService.deleteByScenicZone_scenicSpotId(id);
