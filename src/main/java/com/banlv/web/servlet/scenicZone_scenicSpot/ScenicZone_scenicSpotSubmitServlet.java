...
@WebServlet("/scenicZone_scenicSpotsubmitservlet")
public class ScenicZone_scenicSpotSubmitServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        int i = scenicZone_scenicSpotService.addScenicZone_scenicSpot(scenicZone_scenicSpotfromWeb);
