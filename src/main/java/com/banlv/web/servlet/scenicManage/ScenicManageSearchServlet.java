...
@WebServlet("/scenicManagesearchservlet")
public class ScenicManageSearchServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        PageBean<ScenicManage> allByPage = scenicManageService.searchAllByPage(currentPage,rows,scenicManagefromWeb);
