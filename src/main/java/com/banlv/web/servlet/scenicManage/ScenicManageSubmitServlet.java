...
@WebServlet("/scenicManagesubmitservlet")
public class ScenicManageSubmitServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        int i = scenicManageService.addScenicManage(scenicManagefromWeb);
