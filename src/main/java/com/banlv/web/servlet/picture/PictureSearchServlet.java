...
@WebServlet("/picturesearchservlet")
public class PictureSearchServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        PageBean<Picture> allByPage = pictureService.searchAllByPage(currentPage,rows,picturefromWeb);
