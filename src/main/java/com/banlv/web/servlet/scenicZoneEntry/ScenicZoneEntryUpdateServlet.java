...
@WebServlet("/scenicZoneEntryupdateservlet")
public class ScenicZoneEntryUpdateServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        int i = scenicZoneEntryService.updateScenicZoneEntry(scenicZoneEntryfromWeb);
