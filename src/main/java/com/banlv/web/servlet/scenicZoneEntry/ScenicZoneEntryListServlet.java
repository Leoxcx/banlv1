...
@WebServlet("/scenicZoneEntrylistservlet")
public class ScenicZoneEntryListServlet  extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        PageBean<ScenicZoneEntry> allByPage = scenicZoneEntryService.findAllByPage(currentPage, rows);
