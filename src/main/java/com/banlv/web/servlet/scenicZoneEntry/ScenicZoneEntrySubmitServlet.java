...
@WebServlet("/scenicZoneEntrysubmitservlet")
public class ScenicZoneEntrySubmitServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        int i = scenicZoneEntryService.addScenicZoneEntry(scenicZoneEntryfromWeb);
