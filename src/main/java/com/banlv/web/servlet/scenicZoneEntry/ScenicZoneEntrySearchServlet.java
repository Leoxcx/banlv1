...
@WebServlet("/scenicZoneEntrysearchservlet")
public class ScenicZoneEntrySearchServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        PageBean<ScenicZoneEntry> allByPage = scenicZoneEntryService.searchAllByPage(currentPage,rows,scenicZoneEntryfromWeb);
