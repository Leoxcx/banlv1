...
@WebServlet("/scenicZone_scenicZoneEntrytotalsearchservlet")
public class ScenicZone_scenicZoneEntryTotalSearchServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        List<ScenicZone_scenicZoneEntry> scenicZone_scenicZoneEntrys = scenicZone_scenicZoneEntryService.searchAll(scenicZone_scenicZoneEntryfromWeb);
