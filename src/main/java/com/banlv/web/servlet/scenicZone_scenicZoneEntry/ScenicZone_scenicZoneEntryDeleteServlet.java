...
@WebServlet("/scenicZone_scenicZoneEntrydeleteservlet")
public class ScenicZone_scenicZoneEntryDeleteServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        int i = scenicZone_scenicZoneEntryService.deleteByScenicZone_scenicZoneEntryId(id);
