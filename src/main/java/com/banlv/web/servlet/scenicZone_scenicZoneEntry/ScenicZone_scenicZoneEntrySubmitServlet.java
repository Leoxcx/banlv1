...
@WebServlet("/scenicZone_scenicZoneEntrysubmitservlet")
public class ScenicZone_scenicZoneEntrySubmitServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        int i = scenicZone_scenicZoneEntryService.addScenicZone_scenicZoneEntry(scenicZone_scenicZoneEntryfromWeb);
