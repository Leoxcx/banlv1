...
@WebServlet("/scenicSpottotalsearchservlet")
public class ScenicSpotTotalSearchServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        List<ScenicSpot> scenicSpots = scenicSpotService.searchAll(scenicSpotfromWeb);
