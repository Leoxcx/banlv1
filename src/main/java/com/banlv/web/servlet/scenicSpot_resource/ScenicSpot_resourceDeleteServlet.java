...
@WebServlet("/scenicSpot_resourcedeleteservlet")
public class ScenicSpot_resourceDeleteServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        int i = scenicSpot_resourceService.deleteByScenicSpot_resourceId(id);
