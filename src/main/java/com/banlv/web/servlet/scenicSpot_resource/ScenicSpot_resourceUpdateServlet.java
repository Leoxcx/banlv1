...
@WebServlet("/scenicSpot_resourceupdateservlet")
public class ScenicSpot_resourceUpdateServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        int i = scenicSpot_resourceService.updateScenicSpot_resource(scenicSpot_resourcefromWeb);
