...
@WebServlet("/user_resourcesubmitservlet")
public class User_resourceSubmitServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        int i = user_resourceService.addUser_resource(user_resourcefromWeb);
