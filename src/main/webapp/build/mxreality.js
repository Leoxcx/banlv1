    ...
    var o = {
        ...
        toolBar: function (e) {
            ...
            var u = this.createTag("span", {style: "width:2.2rem;height:2.2rem;position:inherit;left:50%;margin-left:-1.1rem;margin-top:-0.75rem;color:#fff;font-size:1.5rem;cursor:pointer;margin-top:1rem;border:0.0625rem dotted #ccc;height:0.0625rem;"}, {innerHTML: ""}),
                h = this.createTag("div", {style: "width:100%;height:auto;position:inherit;background:rgba(0,0,0,0);top:2.4rem;bottom:1.8rem;overflow: hidden;"}, null),
            ...
            var p = this.createTag("div", {style: "position:inherit;right:5.8rem;cursor:pointer;bottom:0.2rem;line-height:100%"}, {innerHTML: o.playerIcon.resetLookAtSvg});
            n.appendChild(p);
            var f = this.createTag("div", {style: "position:inherit;right:3.5rem;cursor:pointer;bottom:0.1rem;line-height:100%"}, {innerHTML: o.playerIcon.gyroSvg});
            n.appendChild(f);
            var g = this.createTag("div", {style: "position:inherit;right:1rem;cursor:pointer;bottom:0.1rem;line-height:100%"}, {innerHTML: o.playerIcon.vrSvg});
            n.appendChild(g);
            var E = this.createTag("div", {style: "position:inherit;top:0rem;width:100%;height:0.1rem;background:rgba(255,255,255,.3);cursor:pointer"}),
                y = this.createTag("div", {style: "position:inherit;width:0%;height:0.1rem;background:rgba(255,255,255,.3)"});
            E.appendChild(y);
            var T = this.createTag("div", {style: "position:inherit;width:0%;height:0.1rem;background:rgba(28, 175, 252,.6)"});
